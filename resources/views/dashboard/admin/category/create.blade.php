<x-app-layout>
    <x-slot name="header_content">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a style="text-decoration: none;" href="{{route('category.index')}}"><i class="fa-solid fa-tags"></i> {{ __('Kategori') }}</a></li>
            <li class="breadcrumb-item active"><a><i class="fa-solid fa-hashtag"></i> {{ __('Tambah Kategori') }}</a></li>
        </ol>
    </x-slot>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="mx-auto">Tambah Kategori</h4>
                    </div>
